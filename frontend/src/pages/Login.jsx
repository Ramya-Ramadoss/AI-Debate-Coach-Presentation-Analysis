    ...
    <div className="min-h-screen bg-[#05020c] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-xl font-bold tracking-wide text-white font-sans">DEBATE COACH</h2>
          <p className="text-xs text-slate-400 mt-1 font-light">Sign in to your coaching dashboard</p>
        </div>
        ...
        <div className="glass-panel border border-white/5 p-8 rounded-3xl shadow-2xl relative">
          ...
          <div className="mt-8 text-center text-xs text-slate-400 border-t border-white/5 pt-6">
            ...
            <Link to="/register" className="text-purple-400 font-semibold hover:text-purple-300 transition duration-200">
              Create an account
            </Link>
          </div>
        </div>
